 ...
 */
final class Version20240306111058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE emotional_security_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE emotional_security (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE game (id INT NOT NULL, name VARCHAR(255) NOT NULL, isbn VARCHAR(13) NOT NULL, grog_link VARCHAR(2080) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE game_author (game_id INT NOT NULL, author_id INT NOT NULL, PRIMARY KEY(game_id, author_id))');
        $this->addSql('CREATE INDEX IDX_C09A7500E48FD905 ON game_author (game_id)');
        $this->addSql('CREATE INDEX IDX_C09A7500F675F31B ON game_author (author_id)');
        $this->addSql('CREATE TABLE game_session (id INT NOT NULL, scenario_id INT DEFAULT NULL, game_id INT DEFAULT NULL, status_id INT NOT NULL, emotional_security_id INT NOT NULL, role_id INT DEFAULT NULL, starting_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ending_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, min_players SMALLINT NOT NULL, max_players SMALLINT NOT NULL, game_master_number SMALLINT NOT NULL, synopsis TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_4586AAFB1B70CC0C ON game_session (emotional_security_id)');
        ...
        $this->addSql('CREATE TABLE physical_table (id INT NOT NULL, event_id INT NOT NULL, seats_number SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE scenario (id INT NOT NULL, name VARCHAR(255) NOT NULL, grog_link VARCHAR(2080) DEFAULT NULL, isbn VARCHAR(13) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE game_author ADD CONSTRAINT FK_C09A7500E48FD905 FOREIGN KEY (game_id) REFERENCES game (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE game_author ADD CONSTRAINT FK_C09A7500F675F31B FOREIGN KEY (author_id) REFERENCES author (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE game_session ADD CONSTRAINT FK_4586AAFB1B70CC0C FOREIGN KEY (emotional_security_id) REFERENCES emotional_security (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE emotional_security_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE game_author DROP CONSTRAINT FK_C09A7500E48FD905');
        $this->addSql('ALTER TABLE game_author DROP CONSTRAINT FK_C09A7500F675F31B');
        ...
        $this->addSql('ALTER TABLE game_session DROP CONSTRAINT FK_4586AAFB1B70CC0C');
        ...
        $this->addSql('DROP TABLE emotional_security');
