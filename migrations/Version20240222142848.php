 ...
 */
final class Version20240222142848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE game_table_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE emotionnal_security (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE event (id INT NOT NULL, name VARCHAR(255) NOT NULL, starting_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ending_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, reservation_starting_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, reservation_ending_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, table_creation_starting_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, table_creation_ending_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE game_session (id INT NOT NULL, scenario_id INT DEFAULT NULL, rpg_id INT DEFAULT NULL, status_id INT NOT NULL, emotionnal_security_id INT NOT NULL, starting_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ending_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, min_players SMALLINT NOT NULL, max_players SMALLINT NOT NULL, synopsis TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE game_table (id INT NOT NULL, event_id INT NOT NULL, seating SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C41AF6C971F7E88B ON game_table (event_id)');
        $this->addSql('CREATE TABLE genre (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE member (id INT NOT NULL, membership_end_date DATE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE rpg (id INT NOT NULL, name VARCHAR(255) NOT NULL, grog_link VARCHAR(2080) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE scenario (id INT NOT NULL, name VARCHAR(255) NOT NULL, grog_link VARCHAR(2080) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, surname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(15) DEFAULT NULL, discord VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE game_table ADD CONSTRAINT FK_C41AF6C971F7E88B FOREIGN KEY (event_id) REFERENCES event (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE game_table_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE game_table DROP CONSTRAINT FK_C41AF6C971F7E88B');
